  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">健康码管理系统</a>
    ...
    <div class="site-navbar__body clearfix">
	 ...
	 -->
        ...
        <div><img src="../assets/img/user.png" style="width: 35px;height: 35px;position: relative;right: -95px;top: 8px;"/></div>
      </div>
    </div>
    <!-- 弹窗, 修改密码 -->
        ...
        this.$confirm(`确定进行[退出]操作?`, '提示', {
          ...
          .then(() => {
            this.$http({
              ...
              if (data && data=='logout') {
                // this.setCookie(name, "feng", -1); 
                console.log(document.cookie)
                this.clearCookie()
                Cookies.remove('sso_token')
                Cookies.remove('sso_token_account')
