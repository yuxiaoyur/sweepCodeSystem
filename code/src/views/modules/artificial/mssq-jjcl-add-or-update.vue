    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
	        ...
	        if (this.dataForm.id) { 
	          this.$http({
	            url: this.$http.adornUrl(`/mssq/jjcl/detail?id=` + this.dataForm.id),
	            method: 'get'
	          }).then(({data}) => {     
      ...
      dataFormSubmit () {
        ...
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/mssq/jjcl/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
              ...
              if (data && data.successful) {
				this.$http({
				  url: this.$http.adornUrl(`/mssq/jjcl/bllc`),
				  method: 'post',
				  params: this.$http.adornParams({
				    'id': data.data,
					'lcmc': lcmc.toString(),
