  ...
  <el-dialog
    ...
    <el-form :model="dataForm" ref="dataForm" label-width="20%" :rules="rules">
      <el-form-item label="数据库名称" prop="dbName">
        <el-input v-model="dataForm.dbName" :disabled="viewDisable"></el-input>
      </el-form-item>
      <el-form-item label="数据表名称" prop="dbTable">
        <el-input v-model="dataForm.dbTable" :disabled="viewDisable"></el-input>
      </el-form-item>
    ...
    methods: {
      ...
      initializing (id, subType) {
        ...
        this.$nextTick(() => {
          ...
          if (typeof (id) === 'number') {
            this.$http({
              url: this.$http.adornUrl('/data_db/table'),
              method: 'get',
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'dbDeptId':this.dataForm.dbDeptId,
