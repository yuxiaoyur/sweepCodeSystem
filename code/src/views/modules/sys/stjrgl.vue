<template>
  <div class="mod-stjrgl-rcjl">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.gjc" placeholder="系统名称" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag v-if="scope.row.zt == 1" size="small" type="danger">异常</el-tag>
...
<script>
  import AddOrUpdate from './stjrgl-xtjrgl-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/stjr/xtjrgljk'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/stjr/xtjrgljk/remove'),
            method: 'post',
