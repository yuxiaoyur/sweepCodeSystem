<template>
  <div class="mod-department">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.bmmc" placeholder="部门名称" clearable></el-input>
      </el-form-item>
      <!--<el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/dockingDepartment/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/dockingDepartment/remove'),
            method: 'post',
