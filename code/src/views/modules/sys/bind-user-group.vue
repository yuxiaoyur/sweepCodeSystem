<template>
  ...
  <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.GROUPNAME" placeholder="用户组名" clearable></el-input>
      </el-form-item>
      <el-form-item>
      ...
      bindHandle (id) {
        ...
        this.$confirm(`确定进行[绑定]操作?`, '提示', {
          ...
          this.$http({
            ...
            method: 'post',
            data: this.$http.adornData({id:that.dataForm.id,bindingId:id,type:'group'},false)
          }).then(({data}) => {
            if (data.successful) {
              this.$message({
                message: '操作成功',
